...
@Component
public class ReservationsByArrivalDispatcher implements IEndPointDispatcher {
    private static final Logger logger = LoggerFactory.getLogger(ReservationsByArrivalDispatcher.class);
    ...
    public String dispatchPost() {
        ...
        try {
            Resource[] resources = resolver.getResources("classpath:templates/endpoint/reservationsbyarrival/post/*.*");
