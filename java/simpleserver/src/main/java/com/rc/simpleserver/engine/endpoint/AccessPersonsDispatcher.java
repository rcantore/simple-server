...
@Component
public class AccessPersonsDispatcher implements IEndPointDispatcher {
    private static final Logger logger = LoggerFactory.getLogger(AccessPersonsDispatcher.class);
    ...
    public String dispatchPost() {
        ...
        try {
            Resource[] resources = resolver.getResources("classpath:templates/endpoint/access_persons.post/*.*");
