...
@Component
public class GetGuestMarketingInformationDispatcher implements IEndPointDispatcher {
    private static final Logger logger = LoggerFactory.getLogger(GetGuestMarketingInformationDispatcher.class);
    ...
    public String dispatchPost() {
        ...
        try {
            Resource[] resources = resolver.getResources("classpath:templates/endpoint/GetGuestMarketingInformation/post/*.*");
